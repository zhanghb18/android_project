...
//import com.example.seino.User.UserApplication;
//import com.example.seino.bean.GsonFunction;
...
//                        UserApplication.setUsername(userInfo.getString("username"));
//                        UserApplication.setNickname(userInfo.getString("nickname"));
//                        UserApplication.setPhoneNumber(userInfo.getString("phoneNumber"));
